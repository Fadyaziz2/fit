    ...
    public function run()
    {
        $roles = [
            [
                ...
                'workout', 'workout-list', 'workout-add', 'workout-edit', 'workout-delete','category', 'category-list', 'category-add', 'category-edit', 'category-delete', 'tags', 'tags-list', 'tags-add', 'tags-edit', 'tags-delete','post', 'post-list', 'post-add', 'post-edit', 'post-delete', 'pages', 'terms-condition', 'privacy-policy', 'productcategory', 'productcategory-list', 'productcategory-add', 'productcategory-edit', 'productcategory-delete', 'product', 'product-list', 'product-add', 'product-edit', 'product-delete', 'banner', 'banner-list', 'banner-add', 'banner-edit', 'banner-delete', 'exclusive-offer', 'exclusive-offer-list', 'exclusive-offer-add', 'exclusive-offer-edit', 'exclusive-offer-delete', 'successstory', 'successstory-list', 'successstory-add', 'successstory-edit', 'successstory-delete', 'package', 'package-list', 'package-add', 'package-edit', 'package-delete', 'pushnotification', 'pushnotification-list', 'pushnotification-add', 'pushnotification-delete', 'subscription', 'subscription-list', 'quotes', 'quotes-list', 'quotes-add', 'quotes-edit', 'quotes-delete', 'subscription-add', 'discount-code', 'discount-code-list', 'discount-code-add', 'discount-code-edit', 'discount-code-delete',
