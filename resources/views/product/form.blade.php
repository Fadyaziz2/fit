                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                {{ html()->label(__('message.affiliate_link').' <span class="text-danger">*</span>')->class('form-control-label') }}
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="form-check">
                                    <div class="custom-control custom-radio d-inline-block col-4">
                                        ...
                                        {{ html()->radio('featured', old('featured') == 'yes' || true, 'yes')->class('form-check-input')->id('featured-yes') }}
                                    </div>
                                    <div class="custom-control custom-radio d-inline-block col-4">
                                        <label class="form-check-label" for="featured-no">{{ __('message.no') }}</label>
                                        {{ html()->radio('featured', old('featured') == 'no', 'no')->class('form-check-input')->id('featured-no') }}
                                    </div>
                                </div>
                            </div>
