@php
    ...
    $MyNavBar = \Menu::make('MenuList', function ($menu) use($url){
        ...
        $menu->add('<span class="item-name">'.__('message.sms_center').'</span>', ['route' => 'sms.index'])
            ->data('permission', ['sms-center-list', 'sms-center-send'])
            ->prepend('<i class="icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="3" y="5" width="18" height="14" rx="2" stroke="currentColor" stroke-width="1.5"/>
                    <path d="M4 7L11.1056 11.7369C11.6609 12.106 12.3391 12.106 12.8944 11.7369L20 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg></i>')
        ...
        $menu->add('<span class="item-name">'.__('message.email_center').'</span>', ['route' => 'emails.index'])
            ->data('permission', ['email-center-list', 'email-center-send'])
            ->prepend('<i class="icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        $menu->add('<span class="item-name">'.__('message.clinic_management').'</span>', ['class' => ''])
            ->prepend('<i class="icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3 9.5C3 8.11929 4.11929 7 5.5 7H18.5C19.8807 7 21 8.11929 21 9.5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V9.5Z" stroke="currentColor" stroke-width="1.5"/>
                    <path d="M7 7V5.5C7 4.11929 8.11929 3 9.5 3H14.5C15.8807 3 17 4.11929 17 5.5V7" stroke="currentColor" stroke-width="1.5"/>
                    <path d="M8 11H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                    <path d="M14 11H16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
        ...
        $menu->add('<span class="item-name">'.__('message.product').'</span>', ['class' => ''])
                ...
                ->nickname('product')
                ->data('permission', ['product-list', 'productcategory-list', 'banner-list', 'banner-add', 'exclusive-offer-list', 'exclusive-offer-add'])
                ->link->attr(['class' => 'nav-link' ])
                ->href('#product');
            ...
            $menu->product->add('<span class="item-name">'.__('message.list_form_title',['form' => __('message.exclusive_offer')]).'</span>', ['route' => 'exclusive-offer.index'])
                ->data('permission', 'exclusive-offer-list')
                ->prepend('<i class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor"><g><circle cx="12" cy="12" r="8" fill="currentColor"></circle></g></svg></i>')
                ->link->attr(['class' => activeRoute(route('exclusive-offer.index')) ? 'nav-link active' : 'nav-link']);

            $menu->product->add('<span class="item-name">'.__('message.add_form_title',['form' => __('message.exclusive_offer')]).'</span>', ['route' => 'exclusive-offer.create'])
                ->data('permission', ['exclusive-offer-add', 'exclusive-offer-edit'])
                ->prepend('<i class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor"><g><circle cx="12" cy="12" r="8" fill="currentColor"></circle></g></svg></i>')
