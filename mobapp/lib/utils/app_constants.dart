...
const ASSIGNED_SPECIALIST_ID = 'ASSIGNED_SPECIALIST_ID';
const FREE_BOOKING_USED_AT = 'FREE_BOOKING_USED_AT';
const ASSIGNED_SPECIALIST_BRANCH_ID = 'ASSIGNED_SPECIALIST_BRANCH_ID';
...
const PUSHER_ENABLED = "PUSHER_ENABLED";
